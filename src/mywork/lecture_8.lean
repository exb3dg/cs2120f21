...
/- and is defined as right associative P ∧ Q ∧ R ⟶ P ∧ (Q ∧ R) -/
begin
  assume P Q R,
  assume h,
  ...
  p fills in the underscore in the line above 
  -/
end
...
axioms (Joe_is_tall Joe_chews_gum : Prop) /- assume we have a proof of both -/
axiom jcg: Joe_chews_gum /- jcp is the proof of Joe_chews_gum -/
