...
Theorem: 2 = 2.
Proof: By the reflexive property of equality 2 = 2.
...
example : 2 = 2 :=
  eq.refl 2
-- By the reflexive property of equality when given an 
-- object t, of type Type, it will return t
...
answer: Abductive (guess and test)
...
answer: Deductive (using unknown proofs to 
make bigger proofs)
